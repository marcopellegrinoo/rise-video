# -*- coding: utf-8 -*-
"""rise_spatial_gaussian_single_noise.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1nKgTvnE3nC1aC0u5-j1AOHDFrN72l3-a
...
sigma_x_values = [0.50,0.75,1.0,1.25,1.50,1.75,2.0,2.50,3.0,3.50,4]
sigma_y_values = [0.50,0.75,1.0,1.25,1.50,1.75,2.0,2.50,3.0,3.50,4]

for nr_setup,sigma_x in enumerate(sigma_x_values):
  # per ogni coppia (sigma_x,sigma_y) conservo le stats medie su Insertion/Deletion per poterle confrontare
  ...
  for sigma_y in sigma_y_values:
    ...
    print(f"####################### Setup #{nr_setup+1}: sigma_x={sigma_x}, sigma_y={sigma_y} with N=1000 #######################")
  ...
  df_stats_mean_insertion.to_csv(os.path.join(work_path, f"Water_Resources/rise-video/XAI/spatial/results/additive_gaussian_noise/setup_{nr_setup+1}/setup_{nr_setup+1}_all_stats_mean_insertion.csv"), index=False)
  df_stats_mean_deletion.to_csv(os.path.join(work_path, f"Water_Resources/rise-video/XAI/spatial/results/additive_gaussian_noise/setup_{nr_setup+1}/setup_{nr_setup+1}_all_stats_mean_deletion.csv"),   index=False)
