...
#SBATCH --error=/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial/logs/marco_lime_shap_spatial_multiplicative_norm_zero.err               # standard error file
#SBATCH --output=/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial/logs/marco_lime_shap_spatial_multiplicative_norm_zero.out              # standard output file
...
DIR_NAME="01_marco_spatial_lime_shap_"$TIMESTAMP_VAR
