...
#SBATCH --error=/leonardo_scratch/fast/try25_pellegrino/results/logs/rise_spatial_gaussian_single_noise.err               # standard error file
#SBATCH --output=/leonardo_scratch/fast/try25_pellegrino/results/logs/rise_spatial_gaussian_single_noise.out              # standard output file
...
python rise_spatial_gaussian_single_noise.py
