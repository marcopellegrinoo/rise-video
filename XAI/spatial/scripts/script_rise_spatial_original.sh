...
#SBATCH --mem=40000
#SBATCH --error=/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial/logs/rise_spatial_original.err               # standard error file
#SBATCH --output=/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial/logs/rise_spatial_original.out              # standard output file
...
DIR_NAME="01_spatial_rise_original_"$TIMESTAMP_VAR
