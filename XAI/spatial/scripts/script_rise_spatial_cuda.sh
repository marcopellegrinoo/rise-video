...
#SBATCH --error=/leonard_scratch/fast/try25_pellegrino/results/logs/rise_spatial.err               # standard error file
#SBATCH --output=/leonard_scratch/fast/try25_pellegrino/results/logs/rise_spatial.out              # standard output file
