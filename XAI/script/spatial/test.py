...
v_test_OHE_path = os.path.join(work_path, "Water_Resources/rise_video/data/Vottignasco/Vottignasco_00425010001_test_month_OHE.npy")
v_test_image_path = os.path.join(work_path, "Water_Resources/rise_video/data/Vottignasco/Vottignasco_00425010001_test_normalized_image_sequences.npy")
v_test_target_dates_path = os.path.join(work_path, "Water_Resources/rise_video/data/Vottignasco/Vottignasco_00425010001_test_target_dates.npy")
