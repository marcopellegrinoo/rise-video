...
#SBATCH --error=/leonardo_scratch/fast/try25_pellegrino/results/logs/shap_st_cineca.err         # standard error file
#SBATCH --output=/leonardo_scratch/fast/try25_pellegrino/results/logs/shap_st_cineca.out        # standard output file
