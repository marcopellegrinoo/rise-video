...
#SBATCH --mem=40000 
#SBATCH --error=/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/logs/05_marco_st_rise_original_stability.err               # standard error file
#SBATCH --output=/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/logs/05_marco_st_rise_original_stability.out              # standard output file
...
DIR_NAME="05_marco_st_rise_original_stability"
mkdir $RESULT_PATH/$DIR_NAME

python rise_st_original_stability_5.py $RESULT_PATH/$DIR_NAME