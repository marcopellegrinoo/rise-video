...
# results = []
# seed_values = [5,7,11,26,49,56,57,63,70,97]

# for seed in seed_values:
#     path_to_load_results = f"/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/results/01_marco_st_lime_shap_stability/lime_shap_st_results_setup_ns_8_comp_2_seed_{seed}.pkl"
...
#     output_path_mean_rot1 = f"/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/scripts/notebooks/results/results_st_lime_stability_mean/#{nr_instance}_mean_rot1"
#     output_path_mean_rot2 = f"/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/scripts/notebooks/results/results_st_lime_stability_mean/#{nr_instance}_mean_rot2"
#     output_path_std_rot1  = f"/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/scripts/notebooks/results/results_st_lime_stability_std/#{nr_instance}_std_rot1"
#     output_path_std_rot2  = f"/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/scripts/notebooks/results/results_st_lime_stability_std/#{nr_instance}_std_rot2"

#     all_nr_instances_instances_s_i = np.zeros((10,104,5,8))

#     for nr_result,result in enumerate(results):
#         all_nr_instances_instances_s_i[nr_result] = result["lime"]["ns_8_comp_2_kw_90_alpha_0.1"]["saliency_videos"][nr_instance]
...
#     plot_saliency_video_3d(s_i_mean_all_seed_instance_nr_instance, 95, high_worst=False, elev = 30,  azim = -40,
...
#                        target_shapefile = arpa_wt_sensors, title_ext= f"LIME Saliency Mean #{nr_instance}, Date Target: {data_target} - Coefficients",
#                        save=True, save_path=output_path_mean_rot1)
    
#     plot_saliency_video_3d(s_i_mean_all_seed_instance_nr_instance, 95, high_worst=False, elev = 35,  azim = -30,
#                        test_images_dates = vottignasco_test_image_dates, instance_number = nr_instance,
#                        shapefile = piedmont_bounds, ROI_box = ROI_box, clip_bounds=[xmin_clip, xmax_clip, ymin_clip, ymax_clip],
#                        target_shapefile = arpa_wt_sensors, title_ext= f"LIME Saliency Mean #{nr_instance}, Date Target: {data_target} - Coefficients",
#                        save=True, save_path=output_path_mean_rot2)
    
#     plot_saliency_video_3d(s_i_std_all_seed_instance_nr_instance, 95, high_worst=False, elev = 30,  azim = -40,
#                        test_images_dates = vottignasco_test_image_dates, instance_number = nr_instance,
#                        shapefile = piedmont_bounds, ROI_box = ROI_box, clip_bounds=[xmin_clip, xmax_clip, ymin_clip, ymax_clip],
#                        target_shapefile = arpa_wt_sensors, title_ext= f"LIME Saliency Std #{nr_instance}, Date Target: {data_target} - Coefficients",
...
for nr_instance in range(0,len(vottignasco_test_image)):
    ...
    #for index_i in range(2,5):
    output_path_mean_rot1 = f"/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/scripts/notebooks/results/results_st_shap_stability_mean/#{nr_instance}_mean_rot1"
    output_path_mean_rot2 = f"/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/scripts/notebooks/results/results_st_shap_stability_mean/#{nr_instance}_mean_rot2"
    output_path_std_rot1  = f"/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/scripts/notebooks/results/results_st_shap_stability_std/#{nr_instance}_std_rot1"
    output_path_std_rot2  = f"/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/scripts/notebooks/results/results_st_shap_stability_std/#{nr_instance}_std_rot2"

    all_nr_instances_instances_s_i = np.zeros((10,104,5,8))

    for nr_result,result in enumerate(results):
        all_nr_instances_instances_s_i[nr_result] = result["shap"]["ns_8_comp_2"]["saliency_videos"][nr_instance]
    ...
    plot_saliency_video_3d(s_i_mean_all_seed_instance_nr_instance, 95, high_worst=False, elev = 30,  azim = -40,
                       test_images_dates = vottignasco_test_image_dates, instance_number = nr_instance,
                       shapefile = piedmont_bounds, ROI_box = ROI_box, clip_bounds=[xmin_clip, xmax_clip, ymin_clip, ymax_clip],
                       target_shapefile = arpa_wt_sensors, title_ext= f"SHAP Saliency Mean #{nr_instance}, Date Target: {data_target} - Coefficients",
                       save=True, save_path=output_path_mean_rot1)
    ...
    plot_saliency_video_3d(s_i_std_all_seed_instance_nr_instance, 95, high_worst=False, elev = 30,  azim = -40,
                       test_images_dates = vottignasco_test_image_dates, instance_number = nr_instance,
                       shapefile = piedmont_bounds, ROI_box = ROI_box, clip_bounds=[xmin_clip, xmax_clip, ymin_clip, ymax_clip],
                       target_shapefile = arpa_wt_sensors, title_ext= f"SHAP Saliency Std #{nr_instance}, Date Target: {data_target} - Coefficients",
                       save=True, save_path=output_path_std_rot1)
