...
#SBATCH --error=/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/logs/lime_shap_st_stability.err               # standard error file
#SBATCH --output=/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/logs/lime_shap_st_stability.out              # standard output file
...
DIR_NAME="01_marco_st_lime_shap_stability"$TIMESTAMP_VAR

mkdir $RESULT_PATH/$DIR_NAME

python lime_shap_st_stability.py $RESULT_PATH/$DIR_NAME