...
#SBATCH --mem=40000 
#SBATCH --error=/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/logs/marco_rise_st_original_25.err               # standard error file
#SBATCH --output=/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/logs/marco_rise_st_original_25.out              # standard output file
...
python rise_st_original_5.py $RESULT_PATH/$DIR_NAME