...
#SBATCH --mem=40000 
#SBATCH --error=/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/logs/shap_st_plots3D_stability.err               # standard error file
#SBATCH --output=/leonardo_work/try25_pellegrino/Water_Resources/rise-video/XAI/spatial_temporal/logs/shap_st_plots3D_stability.out              # standard output file
...
python lime_st_plots3D_stability.py 